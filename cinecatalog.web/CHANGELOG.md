...
- Crie um projeto react com create-vite: `npm init --yes vite@latest cinecatalog.web -- --template=react  --no-rolldown --no-immediate`.
- Atualizando `vite.config.js`com a porta.
- Criar o arquivo de projeto (`cinecatalog.web.esproj`).
